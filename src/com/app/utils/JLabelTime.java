 ...
 * @author Servidor
 */
public class JLabelTime extends JLabel implements Runnable {

    private String dia, mes, año, hora, minutos, segundos;
    private Calendar calendario = new GregorianCalendar();
    Thread hilo;

    public JLabelTime(int x, int y, int p, int p1) { //Constructor 
        setBounds(x, y, p, p1);
    ...
    public void run() {
        ...
        while (ct == hilo) {
            try {
                ...
                setText("<html>"+"Fecha: "+ dia + " / " + mesE + " / " + año +"<br><br>" +"Hora: " + hora + ":" + minutos + ":" + segundos);
